    ...
    <div class="container">
        ...
        <form action="settings" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="form-input-wrapper">
                    <input type="email" id="email" name="email" required class="form-input rounded">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="button-group">
                <button type="submit" class="button register-button rounded-button">Сохранить изменения</button>
            </div>
        </form>
    </div>
</body>
