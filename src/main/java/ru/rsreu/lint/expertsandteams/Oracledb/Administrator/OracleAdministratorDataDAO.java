package ru.rsreu.lint.expertsandteams.Oracledb.Administrator;
...
public class OracleAdministratorDataDAO implements AdministratorDataDAO {
    ...
    public int findExpertIdByTeamId(int teamId) throws SQLException {
        ...
        while (resultSet.next()) {
            result = resultSet.getInt(SQLQueryManager.getProperty("GENERAL.EXPERT_ID.SQL.CONST"));
        }
        resultSet.close();
        preparedStatement.close();
        return result;
    ...
    public int findConsultationIdByExpertId(int expertId) throws SQLException {
        ...
        int result = -1;
        while (resultSet.next()) {
            result = resultSet.getInt(SQLQueryManager.getProperty("GENERAL.CONSULTATION_ID.SQL.CONST"));
        }
        resultSet.close();
        preparedStatement.close();
        return result;
    ...
    public List<TeamsStatisticsDTO> getTeamsStatisticsList() throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            String captainLogin = resultSet.getString(SQLQueryManager.getProperty("GENERAL.LOGIN.SQL.CONST"));
    ...
    public int findUserIdByLogin(String login) throws SQLException {
        ...
        int result = -1;
        while (resultSet.next()) {
            result = resultSet.getInt(SQLQueryManager.getProperty("GENERAL.USER_ID.SQL.CONST"));
        }
        resultSet.close();
        preparedStatement.close();
        return result;
